            ...
            return (!precision ?
                ...
                function(v) {
                    if (isFloat(v))
                        ...
                        //return Array.prototype.splice.apply(output, )
                    return padNumber(toHex(v), precision);
                }
            );
        },
 ...
 * The format string must be of the form "[START,END]" where both START and END
...
var formatterForString = (function(){
    ...
    return function(format) {
        ...
        if (match === null || match[0] === '') {
            ...
            var range = match.slice(2);
            return function(v) {
                return Array.prototype.slice.apply(v, range).join('');
            };
        }
    };
}());
